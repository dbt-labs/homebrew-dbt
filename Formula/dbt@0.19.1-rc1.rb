class DbtAT0191Rc1 < Formula
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.19.1rc1
    url "https://files.pythonhosted.org/packages/a3/a8/49cc13d6903d02bb1b0e76623d9895be2c4ac5ffc86bb37199341c1e3d19/dbt-bigquery-0.19.1rc1.tar.gz"
    sha256 "9d9a7bb0657e5c11b88de0ff145858e35478b4b0bcd79803a40624ce2bd65bb8"
  end

  resource "dbt-core" do # dbt-core==0.19.1rc1
    url "https://files.pythonhosted.org/packages/59/39/732726e0a65ff5b5039a9ba122882ac1cfeab37ff3816bcbd8d6a7d4d6a0/dbt-core-0.19.1rc1.tar.gz"
    sha256 "b72454dc82596ae1942fec654b5fb6676d523b7fa81f861a29117b3f392069f6"
  end

  resource "dbt-postgres" do # dbt-postgres==0.19.1rc1
    url "https://files.pythonhosted.org/packages/af/f6/3baaa9a4b68aea8096949a59bb9a309f0ad694164c5c8641a19009944214/dbt-postgres-0.19.1rc1.tar.gz"
    sha256 "f19bcd04467b70c4cc57f5f3d6f657791237609fc83cb2d7968d36e9d362f279"
  end

  resource "dbt-redshift" do # dbt-redshift==0.19.1rc1
    url "https://files.pythonhosted.org/packages/9a/5c/a7f4542449e98f607069ea1e20a950205f8335d6c73e444498b15cc82481/dbt-redshift-0.19.1rc1.tar.gz"
    sha256 "33cb6929bc7768b38b6fc2ede4813347ac89e13e84a5798e731d662151fd0271"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.19.1rc1
    url "https://files.pythonhosted.org/packages/15/1b/48dcbee95265482ddaa2d4ce9c0abd57ef885b5d7b0f09a88fa70fb4ebc1/dbt-snowflake-0.19.1rc1.tar.gz"
    sha256 "2cfee53a38fc484075fa8aee5847feb23e8fd13ca4777687d337f5d08fbbb59d"
  end
  ...
  resource "proto-plus" do # proto-plus==1.17.0
    url "https://files.pythonhosted.org/packages/d6/9c/a7da0e0dc4a4ed908f53fa044d2ef8e10a08cb4a644e57f292e04fa774a0/proto-plus-1.17.0.tar.gz"
