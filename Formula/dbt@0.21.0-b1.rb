class DbtAT0210B1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/53/2d/551309c9146f033eec7c48fdfaccb65b71c70f14abf7807d26adf58fba0f/dbt-0.21.0b1.tar.gz"
  sha256 "5882e48c29da0e177df02390f191188e749cfe3010e4da9dabe8c6451f362890"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.21.0b1
    url "https://files.pythonhosted.org/packages/de/56/f71808262fac0c738050507f53184818ac7a80bfecf4817861a12273ebaf/dbt-bigquery-0.21.0b1.tar.gz"
    sha256 "136d7a0c95db73b695ff495a05ccfe5be72d873f35a1e0536586fdce23f7162c"
  end

  resource "dbt-core" do # dbt-core==0.21.0b1
    url "https://files.pythonhosted.org/packages/64/89/31631e6b6cfb7371676f40328c5b426840b2aaf79a22c343e21b7cc98360/dbt-core-0.21.0b1.tar.gz"
    sha256 "893da4c18695912f14a4524dd709f03f26b3d9d04e84ca21663f3c5d51966612"
  end

  resource "dbt-postgres" do # dbt-postgres==0.21.0b1
    url "https://files.pythonhosted.org/packages/1b/a6/b47a0487cd908967594bd78f84e2e9368926c25ed819cd624a8f5750416c/dbt-postgres-0.21.0b1.tar.gz"
    sha256 "546c5ce4190ecb91519081dafe7adde8cae6aec107075f21cad5622a560a15fe"
  end

  resource "dbt-redshift" do # dbt-redshift==0.21.0b1
    url "https://files.pythonhosted.org/packages/9e/c8/2f6bd68c067ac0051378e47d7f1e0d487eca5e9e154b4c62dfa192331818/dbt-redshift-0.21.0b1.tar.gz"
    sha256 "cfdc12372ab7cba33a253f60df132b609c9b3488e854e609cb5a1feead2eda18"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.21.0b1
    url "https://files.pythonhosted.org/packages/e4/00/f86a2cc04c1ea4f53e293c5436f38ad30d6dda3bb96c57438a797568b146/dbt-snowflake-0.21.0b1.tar.gz"
    sha256 "d627dae22c0b315ec003d058374354dc6a82fbf4fa795b46d58684e494271f62"
  end
  ...
  resource "boto3" do # boto3==1.18.12
  ...
  resource "botocore" do # botocore==1.21.12
