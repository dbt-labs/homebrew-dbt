class DbtAT0171 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/86/71/d7ad4376a0a83a74bdcd013046b3911272bc531be7d245cfb890f18a4ead/dbt-0.17.1.tar.gz"
  sha256 "c461b6c5411cb61340cc9d5a2df2cda3452a0516ea872db3537d092bc849b0cb"
  revision 1

  bottle do
    root_url "http://bottles.getdbt.com"
    sha256 high_sierra: "5bd10816115a1ca6882a33a395dfdfe6044d449799d46de104c3ffbf22a2384f"
    sha256 mojave:      "d99d36a67517414b6221d672ff21d8281c56123904bb9931e79e7e80574274b8"
    sha256 catalina:    "7f1189c26a49d89665010cee9c4d90e51d1af63a12ae7da99e49bb1851e232a6"
  end
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.17.1
    url "https://files.pythonhosted.org/packages/d6/db/956870978d391325a00caea86877a3fc80e17b9a71b998da227d3012b5b3/dbt-bigquery-0.17.1.tar.gz"
    sha256 "8babc9336b45883bf57c742e3e6d76827943fe9e588e55e11972a9c1a94d12d1"
  end

  resource "dbt-core" do # dbt-core==0.17.1
    url "https://files.pythonhosted.org/packages/05/62/0d21f009e046728727eab22c144982eb99dd930ee91318136c7185935ad3/dbt-core-0.17.1.tar.gz"
    sha256 "04e41d5efedb45f8d509c67339001eebfd6ec52c0e16ff012c660c45f84b776b"
  end

  resource "dbt-postgres" do # dbt-postgres==0.17.1
    url "https://files.pythonhosted.org/packages/1e/b0/0e2ae291c6df4935d900d56ef9a2ca0b74c542105c80f22bb0767cebf0be/dbt-postgres-0.17.1.tar.gz"
    sha256 "57c821e66dd512d9042c2aade0ac08e3d13b2c95ad668999f419cab153778a1f"
  end

  resource "dbt-redshift" do # dbt-redshift==0.17.1
    url "https://files.pythonhosted.org/packages/31/57/f998ff63b7526a3733a8fe9fc0292e78ca48e9421cc820ab51aff1da6c84/dbt-redshift-0.17.1.tar.gz"
    sha256 "dfc389b185be993ff00c989f938e2bd6272432e02c4e8e8c4d89482ba09c674d"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.17.1
    url "https://files.pythonhosted.org/packages/cf/9f/ff8fc426953ac49ae891cc394e38a85df077ef7a9bd03624c0ac5cc547f9/dbt-snowflake-0.17.1.tar.gz"
    sha256 "f5f09320b11a698d297076e4064bbd6ad7f20790ed677c6e505a8634df831de9"
  end
  ...
  resource "google-auth" do # google-auth==1.19.2
