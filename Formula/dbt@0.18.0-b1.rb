class DbtAT0180B1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/a7/b4/b14c01726e9c0eb5de8d585a5742c0ca7b8182fe0add8531053719ffaef8/dbt-0.18.0b1.tar.gz"
  sha256 "c6a674afd199755dd5c5cbda84dad24e93612e060352926b17248194d2500b0c"
  revision 1
  ...
  bottle do
    ...
    sha256 catalina:    "c741234a6170001d5315561f9c72e9173fd5a7c80181f27b5eb095149e198177"
    sha256 high_sierra: "9c6404e06d018d18e8a8d81714b11bebb1079c7e3a87592658382e7370fc7d9d"
    sha256 mojave:      "d64015445a954ae7731f5eaa33fbb2392f3dbebd7d2a732093ed211f860cf1b6"
  end
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.18.0b1
    url "https://files.pythonhosted.org/packages/a7/44/e30275967a17f54ba802272b49555b5fef151727ce8657434a7a54aef6b0/dbt-bigquery-0.18.0b1.tar.gz"
    sha256 "c6d1eb3972f63bb0c626addad4a34b0f9314250d6f2667c218defb84cd3fb7a1"
  end

  resource "dbt-core" do # dbt-core==0.18.0b1
    url "https://files.pythonhosted.org/packages/e5/c1/0fde01be025fbf24fef878809ac97b2bd64e030c57184ad0a300f6f18c7c/dbt-core-0.18.0b1.tar.gz"
    sha256 "81bd452a1c3eb5eccad75945346d7a8445359af1bb9b1e15d668b22f9b4a96e6"
  end

  resource "dbt-postgres" do # dbt-postgres==0.18.0b1
    url "https://files.pythonhosted.org/packages/e2/14/8a8bd706c8cae29a1c5882f1d8c9009dfb3f4eb5381df0a3cfc6189c7c00/dbt-postgres-0.18.0b1.tar.gz"
    sha256 "cb98b3466787bdf9ad03f3d00e6a083dd26040a157129ba418190e15005f18f9"
  end

  resource "dbt-redshift" do # dbt-redshift==0.18.0b1
    url "https://files.pythonhosted.org/packages/f9/16/735c7623388b2225bc8d8a200d1fa42b88cb83e8fd603fc3b63697525d54/dbt-redshift-0.18.0b1.tar.gz"
    sha256 "2c91fada9f1d54e07b0c4e96d234b10636ca2a97f352c10c053a51f8a6cb03b9"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.18.0b1
    url "https://files.pythonhosted.org/packages/8e/28/9f49905792b1dfb48ff1b79990caa60225cc985d1c537c4c51c4a27bc180/dbt-snowflake-0.18.0b1.tar.gz"
    sha256 "059c670b6ae3f97afedb8afcc47827f605bd5a6282f9dcf73e7f002e7b9910be"
  end
  ...
  resource "certifi" do # certifi==2020.4.5.2
  ...
  resource "google-auth" do # google-auth==1.16.1
  ...
  resource "importlib-metadata" do # importlib-metadata==1.6.1
  ...
  resource "protobuf" do # protobuf==3.12.2
  ...
  resource "pytest" do # pytest==5.4.3
  ...
  resource "wcwidth" do # wcwidth==0.2.4
