class DbtAT0182 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/6c/e0/3c1e0448d1cb3850a7258ba3fe56ffd044f5cd2e2b44904fd28996c81dce/dbt-0.18.2.tar.gz"
  sha256 "c425dbd1f7274f86fc3c24bd4c993849be33c34884816748d3490b440d033484"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.18.2
    url "https://files.pythonhosted.org/packages/89/06/c2cce8e31d79543771ea15a9bc147685ed755af362b937c093c9540f39d4/dbt-bigquery-0.18.2.tar.gz"
    sha256 "34f3290e26bc217533d0f269c8178062b9e09f1cd00261e69ed3d6ce0cd55de9"
  end

  resource "dbt-core" do # dbt-core==0.18.2
    url "https://files.pythonhosted.org/packages/83/99/33148385c939f73328658194442600787fa25ada00d0c6dc5edcd05c8f2c/dbt-core-0.18.2.tar.gz"
    sha256 "621c9ce223173f52a7638f3e36efb079c0824082d1f34fcd4a416203fc050896"
  end

  resource "dbt-postgres" do # dbt-postgres==0.18.2
    url "https://files.pythonhosted.org/packages/b4/4e/3218c34a9e9411710b2153408527f2e11580abd264a69d74f195c3a9495a/dbt-postgres-0.18.2.tar.gz"
    sha256 "95011ac46f70b97349d08243d993376539c177710550f6f7abf51ed805f03081"
  end

  resource "dbt-redshift" do # dbt-redshift==0.18.2
    url "https://files.pythonhosted.org/packages/68/72/c35ff6533aeeaf9e8afe410b6dd2c70ed8ef5815c87147b124552b0b12d0/dbt-redshift-0.18.2.tar.gz"
    sha256 "87524d0246fc2f48377dd2e85aa9b2631c09c44669c0aa05c1381c67a01a6059"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.18.2
    url "https://files.pythonhosted.org/packages/78/4a/35f576eb108d75de2a48ac840db4c6a2d369f490dd89637e282930340c33/dbt-snowflake-0.18.2.tar.gz"
    sha256 "15245c36cefad8dd6f1bac0fdfbaffad6bb1d5f14290a5ef0f1d94c5938291f2"
  end
