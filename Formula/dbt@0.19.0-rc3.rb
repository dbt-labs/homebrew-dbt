class DbtAT0190Rc3 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/a6/26/a00d9d7587a851f8febe26c779ae1853b40dff32434f9c4aaaece0923846/dbt-0.19.0rc3.tar.gz"
  sha256 "3ce85e76e150594081a5d5ae093a781b2db8fd3f79de1b9928468630fc27b99c"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.19.0rc3
    url "https://files.pythonhosted.org/packages/21/c1/05ebf3a16c8fd5317112dfe4972ac0f7b38eaacbff94e63d16ef4c3e6111/dbt-bigquery-0.19.0rc3.tar.gz"
    sha256 "2e0a4a1cda46cb661847747e2cdda932b6386c5d9a912951fabb408e1aecbb33"
  end

  resource "dbt-core" do # dbt-core==0.19.0rc3
    url "https://files.pythonhosted.org/packages/b1/f0/79b21a3e06bbd8996499d334201e02e427a0767246c8fcdbf2e4ccb00a41/dbt-core-0.19.0rc3.tar.gz"
    sha256 "23cf66844744ffc3893996820e4643f0dda31fba2d71af6442c912e6936467ac"
  end

  resource "dbt-postgres" do # dbt-postgres==0.19.0rc3
    url "https://files.pythonhosted.org/packages/52/9f/37540262e61dd8abc7e084a77c15cecbe77a774977ba833d6e6e77ac69aa/dbt-postgres-0.19.0rc3.tar.gz"
    sha256 "55c7f5ce6d8e22a5f57a600396678fb1ebb6c658639f526e6d683102e8adff77"
  end

  resource "dbt-redshift" do # dbt-redshift==0.19.0rc3
    url "https://files.pythonhosted.org/packages/84/eb/5866f35835a2903a8fbd448e44334719c698dfbfd6a22eb2a935881024da/dbt-redshift-0.19.0rc3.tar.gz"
    sha256 "4c010a2730ee92050a81667ebe0affe42c9631016bc7dfdeb01b61d7e60da203"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.19.0rc3
    url "https://files.pythonhosted.org/packages/6c/4f/8a8094a7be20b229748c85fbae4563fffdc4f47904ca3600cec13cbb481d/dbt-snowflake-0.19.0rc3.tar.gz"
    sha256 "95266cf7a77266f4e207dc703a5e4fb17b8283f9499a140318786e2f9b4e2b8d"
  end
  ...
  resource "azure-storage-blob" do # azure-storage-blob==12.7.1
