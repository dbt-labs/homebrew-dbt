class DbtAT0211Rc2 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/3a/b6/8b754f345b94cfa57df02e6232cf979179cc5908215eb80cc014449678dc/dbt-0.21.1rc2.tar.gz"
  sha256 "8c3d8538ef0c40677b8cea414f486ff131efb2ba66605503fa349fc65da291dc"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.21.1rc2
    url "https://files.pythonhosted.org/packages/ae/33/d7b39d78c30fa78bff472a4e408a80e9444bd321217ee05542701feccd03/dbt-bigquery-0.21.1rc2.tar.gz"
    sha256 "59d10b343cc95e5ac35957395161c8b96406f111984d3ba6c7447a8580b10955"
  end

  resource "dbt-core" do # dbt-core==0.21.1rc2
    url "https://files.pythonhosted.org/packages/5e/11/750cc6506294f42da8dbf2e9227f96c5b7973b1507adbb258e64ac3ffcb2/dbt-core-0.21.1rc2.tar.gz"
    sha256 "d669e282fe4657a366c14c462c0dd04198cd2f8f7c6f4cf42350c13b97e4d9e1"
  end

  resource "dbt-postgres" do # dbt-postgres==0.21.1rc2
    url "https://files.pythonhosted.org/packages/24/eb/601b9e824800dfdf587ba056883af37034d82d17b985cabf8498d8760afa/dbt-postgres-0.21.1rc2.tar.gz"
    sha256 "82fbe17d508ae0136bafc59ce8a6655710f20e6040398cf8ebec6d053388c4f7"
  end

  resource "dbt-redshift" do # dbt-redshift==0.21.1rc2
    url "https://files.pythonhosted.org/packages/1d/8c/762527981279d0901ce0ed998b3eb4307e3dfe25214bc81600248d4cdf73/dbt-redshift-0.21.1rc2.tar.gz"
    sha256 "b9eec2651711d05fd30ff2e6daf487cf22c68fa3d5d820e106533242a35c218c"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.21.1rc2
    url "https://files.pythonhosted.org/packages/c9/76/27c2aee48ebb1488dc6417662775149862b87ea8766a0eea46c59fe27db4/dbt-snowflake-0.21.1rc2.tar.gz"
    sha256 "febec315ec8424a6f1d280a178f8f5942446786ec46f8fff96c316cd5954fec8"
  end
  ...
  resource "boto3" do # boto3==1.20.5
  ...
  resource "botocore" do # botocore==1.23.5
