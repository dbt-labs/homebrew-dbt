class DbtAT0120Rc1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/26/b4/237f6b7e01d4842773c2024af44aa61eab25dc5d8154415804e98faf9c24/dbt-0.12.0rc1.tar.gz"
  sha256 "8fadbac3448063b4bf2490eb9313b3dd7c54bcbe394bae5f55b0a7dd095c1642"
  
  deprecate! date: "2022-09-13", because: :versioned_formula

  bottle do
    root_url "http://bottles.getdbt.com.s3-website-us-east-1.amazonaws.com"
    sha256 high_sierra: "eb809a50f1bcfd90d06a62dda847f401ffdcfb006921e62ac0cc187d0c174de1"
    sha256 sierra:      "6a464fd07134df4fc70ae16e4dfc90a61e5ccf182356da517f7cd5da9f66c25f"
  end
  ...
  resource "google-api-core" do
    url "https://files.pythonhosted.org/packages/f3/09/a73ccb9c7497b889635eae9976311b2edbad4d06e71eeb3647b60cc7063a/google-api-core-1.5.1.tar.gz"
