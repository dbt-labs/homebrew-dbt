class DbtAT0122Rc1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/ea/c7/a0756122cbb61e1b1c83966391887431ecc72a5958340792b1979425854d/dbt-0.12.2rc1.tar.gz"
  sha256 "8fe4a3f391fb0d82375771ce520b31abe8acd2abdcc75f0b136562d6c7e9af89"

  bottle do
    root_url "http://bottles.getdbt.com.s3-website-us-east-1.amazonaws.com"
    sha256 high_sierra: "535cfa8324b204b81059cb7621973cf60351127d915db82f096e39a15682da1e"
    sha256 sierra:      "35e890d4cc9998f995829d065bf759f36f138839243344a415da0694d844ade1"
  end
  ...
  resource "google-api-core" do
    url "https://files.pythonhosted.org/packages/7b/d5/d4f48a855461fd283d45280c9226aa84a59e17a5321e689aa1f11c9f8db7/google-api-core-1.6.0.tar.gz"
    sha256 "84dca4d7fcf13574ad8e31ba02ad04ffcdb2e5b596383571e3105d9d0ad70d27"
  end
  ...
  resource "snowflake-connector-python" do
    url "https://files.pythonhosted.org/packages/db/4c/6677322ce6ed9a58810ca4833ee17be39f58b4d6fe464201decdf0761613/snowflake-connector-python-1.7.2.tar.gz"
    sha256 "d9b54c35716c4f390c39ac35a30f195c3008171f3ba9d9d8a923ac5510608336"
  end
