class DbtAT0211Rc1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/f3/8a/3c5fa48006f4a6e063d7e0511739e6698fcfb031636b8174c3af5072b03c/dbt-0.21.1rc1.tar.gz"
  sha256 "38917fd03dd275c997b01fb4af28f45f9bb074268606ff6db80cb58c55b3e2b5"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.21.1rc1
    url "https://files.pythonhosted.org/packages/06/72/81c60bfbe1c2ff4af92142a161dd372bdb0f4538b879f64b54490715a417/dbt-bigquery-0.21.1rc1.tar.gz"
    sha256 "56a2d7cda7a93a7348ff2e106d657b5214b8b8e9231c2ec106eb2f869cbbd898"
  end

  resource "dbt-core" do # dbt-core==0.21.1rc1
    url "https://files.pythonhosted.org/packages/8b/65/a7a0d6717ca534bb0e0b1beeb7e483580a040f57107985cce1c2653ecd5a/dbt-core-0.21.1rc1.tar.gz"
    sha256 "fc7ed93350ca71d7df85a292e8f460fdc59e2eeb1a71643afb40ac2051ece50c"
  end

  resource "dbt-postgres" do # dbt-postgres==0.21.1rc1
    url "https://files.pythonhosted.org/packages/fb/ee/d541fe3354c6e45cf071573d307d45f5a95be797647216094b390c9be7b0/dbt-postgres-0.21.1rc1.tar.gz"
    sha256 "4b73be5d6db1c05376c4bfc1104aafc5bf145617754d7ae91cb4d3abbc45c093"
  end

  resource "dbt-redshift" do # dbt-redshift==0.21.1rc1
    url "https://files.pythonhosted.org/packages/84/80/abf4cd2427d972bd41485721e80051b8590c0b618c84399d31d58598f271/dbt-redshift-0.21.1rc1.tar.gz"
    sha256 "98810766679ff07540311de33491af81b11f00e9a532f09e052aa5a88ff204ab"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.21.1rc1
    url "https://files.pythonhosted.org/packages/aa/2f/ed87a5697a9218fe6212e76751013882722870e9be08ffffb4e074e4a8c3/dbt-snowflake-0.21.1rc1.tar.gz"
    sha256 "9e128ee8bb3a5d7bafb8618cd8ad0dcfbef8f9a59c4afe8ed493919e5c625fb8"
  end
  ...
  resource "azure-core" do # azure-core==1.19.1
    url "https://files.pythonhosted.org/packages/c6/87/2e8b21ad2089165f9e0a02b7521068194a98f4c766cedacc173d95c8c78d/azure-core-1.19.1.zip"
    sha256 "b6ad37a124d194bcece581f3b988d3a234f44a39c5bd62e2e47e03153586915b"
  end
  ...
  resource "boto3" do # boto3==1.19.9
  ...
  resource "botocore" do # botocore==1.22.9
  ...
  resource "charset-normalizer" do # charset-normalizer==2.0.7
  ...
  resource "google-cloud-bigquery" do # google-cloud-bigquery==2.29.0
    url "https://files.pythonhosted.org/packages/ea/96/273c42e56468a529657d40ea8f03c99ee69db54de84870de3975ab6803e6/google-cloud-bigquery-2.29.0.tar.gz"
  ...
  resource "grpcio" do # grpcio==1.41.1
  ...
  resource "proto-plus" do # proto-plus==1.19.7
    url "https://files.pythonhosted.org/packages/63/9f/c00716442e649f5f2944127ab33d4af2450289f21b7ae015d80a842fbe08/proto-plus-1.19.7.tar.gz"
  ...
  resource "pyparsing" do # pyparsing==3.0.4
