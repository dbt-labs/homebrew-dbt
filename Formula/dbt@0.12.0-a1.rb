class DbtAT0120A1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/25/80/91ba748ff96f59614eb2671a44b07d60c67efcbfd749efd8818ae8b91059/dbt-0.12.0a1.tar.gz"
  sha256 "024c3c703f24d7a53bf75f28fa0033ca9e240be27269c133893c3abc468766e4"

  bottle do
    root_url "http://bottles.getdbt.com.s3-website-us-east-1.amazonaws.com"
    sha256 high_sierra: "d6aba0488b73a50b78d116f1443db6de42b52001a929552deb4ff1139cde0e97"
    sha256 sierra:      "5562831f922e3aa8e80aac444081e48fbdecf1a21ebfd3185ea12f505c985494"
  end
  ...
  resource "google-api-core" do
    url "https://files.pythonhosted.org/packages/38/57/a5553265195fcb7bb4e38470cd14e19f1c7d54a7234ddf7be3677dc35031/google-api-core-1.5.0.tar.gz"
  ...
  resource "google-cloud-bigquery" do
    url "https://files.pythonhosted.org/packages/e3/b1/d2b3790a647bf9156bf7f68b0807f613be4cdacb113c3706bd9bb4c06c9b/google-cloud-bigquery-1.6.0.tar.gz"
  ...
  resource "snowflake-connector-python" do
    url "https://files.pythonhosted.org/packages/8b/ff/37cc3a12ed8e24c3ca3bee93cd851823e7203e341fb9a3e82dd60171dc6b/snowflake-connector-python-1.6.10.tar.gz"
    sha256 "ef4cdac45402561dd2bf16e217cd7915b9fc2fd2444ed6c2715b8a6e90a3afbf"
  end
