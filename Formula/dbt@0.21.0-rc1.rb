class DbtAT0210Rc1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/d5/59/023ba074ff5e767930b2e96982f008382865b89397981958c32b9709110c/dbt-0.21.0rc1.tar.gz"
  sha256 "b817f0b49184ca83285e6d9605be11c81edc8aa91ab1536b1416662e6d8fdc4a"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.21.0rc1
    url "https://files.pythonhosted.org/packages/f5/d9/c4c113f495e35b966a988772187e3b92129682b92ae74cefe06713f234e6/dbt-bigquery-0.21.0rc1.tar.gz"
    sha256 "a8e464c2a96adb03efe14a6b8a2c49401f7daff99b4b8eaf2c68deeab52dfb86"
  end

  resource "dbt-core" do # dbt-core==0.21.0rc1
    url "https://files.pythonhosted.org/packages/42/9c/a39e08b123f0c5dc101ad39b1764cb9b191a09ffb5a84f4605e5b8329aa8/dbt-core-0.21.0rc1.tar.gz"
    sha256 "f4b8647dfb17a2fa409e00d66129b4ea7170d4421e537f523368f7f59d089445"
  end

  resource "dbt-postgres" do # dbt-postgres==0.21.0rc1
    url "https://files.pythonhosted.org/packages/b2/78/140412f29b5c7d0aafff2a746be2265a62bea9fb090770a55e09026532ec/dbt-postgres-0.21.0rc1.tar.gz"
    sha256 "96bef126a507f1723fc5df461bd2e83f0505048b6ee2c23dca926c9146894ff7"
  end

  resource "dbt-redshift" do # dbt-redshift==0.21.0rc1
    url "https://files.pythonhosted.org/packages/e1/c3/55497fba0ef4dff46f4c6e1f6f824cce1056b49d285a0724513678db28c7/dbt-redshift-0.21.0rc1.tar.gz"
    sha256 "8d949a97656b57468a5584c0d9a5e147bc2b58751022e48514878b9bf9e4339f"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.21.0rc1
    url "https://files.pythonhosted.org/packages/3c/cc/3fa33b840f3994f7d78e345ed67a6bed2482ccb70c8f71e040d03ed23524/dbt-snowflake-0.21.0rc1.tar.gz"
    sha256 "254c2d1903f188f1b75057b3e19d0605904f2a7511864eb483d40ecad2aad773"
  end
  ...
  resource "boto3" do # boto3==1.18.44
    url "https://files.pythonhosted.org/packages/50/6b/996c960d53b44210d060eb9c24e087b344fc62566e5964d68700bcbce3be/boto3-1.18.44.tar.gz"
    sha256 "8bc3211a7d7767c2c72ae9b226edb5eec5bb96989c83696832b8a5c35feb356a"
  end

  resource "botocore" do # botocore==1.21.44
    url "https://files.pythonhosted.org/packages/05/39/81836d601821f60cc33a10480866d9d8eb4554dfb4469a7dfab220375ab6/botocore-1.21.44.tar.gz"
  ...
  resource "protobuf" do # protobuf==3.18.0
