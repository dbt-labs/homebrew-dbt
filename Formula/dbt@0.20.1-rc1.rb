class DbtAT0201Rc1 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/08/3d/807a219de551060d8f4661aad6e88719f3ddca3d0b6db2bd44a4b9a85666/dbt-0.20.1rc1.tar.gz"
  sha256 "967fefb1f0559334666f2ae831223cf5f61a317c052bc24aa8445b5de0d0b463"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.20.1rc1
    url "https://files.pythonhosted.org/packages/e3/da/0286e3243e0ffc9c76f971051988f31156e58cbb3da1149c88efa5f33e3e/dbt-bigquery-0.20.1rc1.tar.gz"
    sha256 "28dc44e8a673be7348b4b3c33ee523896e30dcf17055fd666baebcfda638d648"
  end

  resource "dbt-core" do # dbt-core==0.20.1rc1
    url "https://files.pythonhosted.org/packages/3d/7a/893ed67267ac523f4ca08233ef633ef975c40b9c458f63a2241c9d71ece9/dbt-core-0.20.1rc1.tar.gz"
    sha256 "b73bd463649fe901a9f7d334be264552ca4024aede1f8f04bbc206e8d4a6a0ae"
  end

  resource "dbt-postgres" do # dbt-postgres==0.20.1rc1
    url "https://files.pythonhosted.org/packages/56/4a/e0fb96ba504bf4a3a3955e23f591ba8bb20dc8a0ed7cbd780aa2eb1fb5bb/dbt-postgres-0.20.1rc1.tar.gz"
    sha256 "9d2532a9d71391e3d73d705a4ea8a46949f819d44514091300c7c8efa0afd9cc"
  end

  resource "dbt-redshift" do # dbt-redshift==0.20.1rc1
    url "https://files.pythonhosted.org/packages/e4/3c/3f977c61be33d09508ae56865769244ff25ece2bcd2fd0f1f333f7a4e6ce/dbt-redshift-0.20.1rc1.tar.gz"
    sha256 "6df507c3343ce7846ff132391c6042b81e836748e971b86a42ed3dc4e6d4866f"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.20.1rc1
    url "https://files.pythonhosted.org/packages/71/2f/69fcd6d7acc332f59010893b68ffeb40dde6f2a771242bda428af643d6ef/dbt-snowflake-0.20.1rc1.tar.gz"
    sha256 "0d8476598522c87aec3dad05325c95252e195f7daa9ca208a70b85c0952a9d9c"
  end
  ...
  resource "boto3" do # boto3==1.18.11
  ...
  resource "botocore" do # botocore==1.21.11
  ...
  resource "google-cloud-bigquery" do # google-cloud-bigquery==2.23.2
    url "https://files.pythonhosted.org/packages/ba/3d/368ea9de9cec0b7ddf277511c872463c0f1d3966837cdda896fbbbd31dd0/google-cloud-bigquery-2.23.2.tar.gz"
