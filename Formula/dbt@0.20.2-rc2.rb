class DbtAT0202Rc2 < Formula
  include Language::Python::Virtualenv

  desc "Data build tool"
  homepage "https://github.com/fishtown-analytics/dbt"
  url "https://files.pythonhosted.org/packages/1c/3f/1d8112226692fcb846d64406dabe1944262385b00038fe3ce68c79422e50/dbt-0.20.2rc2.tar.gz"
  sha256 "3dbfca5b578a5a89f4b7dee909b4dfc6ac85cef3ec3b2763592bfd40ebfbd5ad"
  revision 1
  ...
  resource "dbt-bigquery" do # dbt-bigquery==0.20.2rc2
    url "https://files.pythonhosted.org/packages/f9/4a/b84e508f895123c870089390fbac0682abd484a38b3c0cdb27e60489ad76/dbt-bigquery-0.20.2rc2.tar.gz"
    sha256 "bade9eecfd6765bc35d022e48ebc28b9ddd8ed5f62047c11bd68604869d54b52"
  end

  resource "dbt-core" do # dbt-core==0.20.2rc2
    url "https://files.pythonhosted.org/packages/93/6a/b987f1c8085d364c72aa65e9aeb172c628edee0b894fa3c7efa75721a845/dbt-core-0.20.2rc2.tar.gz"
    sha256 "e540b3bcbc045a3c93698054a4beaf16ec6683fe6c302add5682bc7558927cf7"
  end

  resource "dbt-postgres" do # dbt-postgres==0.20.2rc2
    url "https://files.pythonhosted.org/packages/e6/53/021fe3b09232a36b62aca46e8fb2f237ec4bd9d1de842f0a75e5bcd6f04f/dbt-postgres-0.20.2rc2.tar.gz"
    sha256 "8891162e2d288f86a96e9e16902f72c94629b647b3f32d56126482a5d0d2c936"
  end

  resource "dbt-redshift" do # dbt-redshift==0.20.2rc2
    url "https://files.pythonhosted.org/packages/10/95/0f6facffe43e74af3424a4237dd7142e1ce4e1c9e801c0566aabeb78cd37/dbt-redshift-0.20.2rc2.tar.gz"
    sha256 "2267dcbad905d048b10165832c3eb2e6dc7d0fafc7f71bfd9d7a1d9967b7aa40"
  end

  resource "dbt-snowflake" do # dbt-snowflake==0.20.2rc2
    url "https://files.pythonhosted.org/packages/65/a2/dfcf299d1f236c53bbdb924e28e229756088ba34718889833f1530bcae6d/dbt-snowflake-0.20.2rc2.tar.gz"
    sha256 "79f450d259f7674e9a707457d3f042ebbfa4811a79a86bb78e9ab3cfbbdf5fb0"
  end
  ...
  resource "boto3" do # boto3==1.18.30
    url "https://files.pythonhosted.org/packages/67/52/46263df5fa15680933c7cc7daa033de4997823c7cabc8c0de2755329a9e0/boto3-1.18.30.tar.gz"
    sha256 "9bf2a281a6df9f8948d3d322d532d03a1039f57a049a1aa2b72b4a28c9627013"
  end

  resource "botocore" do # botocore==1.21.30
  ...
  resource "google-cloud-bigquery" do # google-cloud-bigquery==2.25.1
    url "https://files.pythonhosted.org/packages/95/47/b4933c3cb2eb4f88eaf1253398d0505a4d76a09658acab7b1218d6add981/google-cloud-bigquery-2.25.1.tar.gz"
  ...
  resource "importlib-metadata" do # importlib-metadata==4.7.1
